...
4. Actions 탭에서 **Deploy GitHub Pages demo** workflow를 실행하거나, `site/**` 변경사항을 push합니다.
...
- 입력 슬라이더를 바꾸면 score와 risk factor가 즉시 업데이트됨
- decision packet JSON을 복사하거나 다운로드할 수 있음
